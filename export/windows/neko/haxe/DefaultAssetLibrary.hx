...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/data/gradiuslvl1.oel", "assets/data/gradiuslvl1.oel");
		type.set ("assets/data/gradiuslvl1.oel", AssetType.TEXT);
		path.set ("assets/data/lev1.oep", "assets/data/lev1.oep");
		type.set ("assets/data/lev1.oep", AssetType.TEXT);
		path.set ("assets/images/tilesgradius.png", "assets/images/tilesgradius.png");
		type.set ("assets/images/tilesgradius.png", AssetType.IMAGE);
		className.set ("flixel/sounds/beep.ogg", __ASSET__flixel_sounds_beep_ogg);
		type.set ("flixel/sounds/beep.ogg", AssetType.SOUND);
		className.set ("flixel/sounds/flixel.ogg", __ASSET__flixel_sounds_flixel_ogg);
		type.set ("flixel/sounds/flixel.ogg", AssetType.SOUND);
		...
		var id;
		id = "assets/data/gradiuslvl1.oel";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/data/lev1.oep";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/images/tilesgradius.png";
		path.set (id, id);
